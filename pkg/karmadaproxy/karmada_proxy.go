...
var (
	...
	karmadaHost = "https://karmada-apiserver.karmada-system.svc.cluster.local:5443/apis"
	//https://192.168.49.200:32443/apis
...
func modifyRequest(req *http.Request) {
	...
	if strings.Contains(req.URL.Path, "") {
		...
		clusterConfig, header, _ := req.FormFile("clusterConfig")
